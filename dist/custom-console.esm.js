...
window.CustomConsole = () => {
    ...
    targetWindow.__originalConsole?.log || console.log;
    targetWindow.__originalConsole?.warn || console.warn;
    targetWindow.__originalConsole?.error || console.error;
    targetWindow.__originalConsole?.info || console.info;
    targetWindow.__originalConsole?.debug || console.debug;
...
//# sourceMappingURL=custom-console.esm.js.map
